...
distant_telescope.default_opts = {
  prompt_title = "< Distant.nvim Telescope >",
  layout_config = {
    width = 0.6,
    height = 0.7,
    prompt_position = "top"
  ...
  attach_mappings = function(prompt_bufnr, _)
    actions.select_default:replace(function()
      ...
      local user = distant_telescope.servers[host]
...
distant_telescope.open = function(user_opts)
  ...
  -- if the user specifies the servers
  if length > 0 then
